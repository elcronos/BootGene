...
public class GeneCodeBean
{
  ...
  private ProyectoBean proy;
  private FormularioBean form;
  ...
  public void crearNombEnti() {
    ...
    public ProyectoBean getProy() {
        return proy;
    }

    public void setProy(ProyectoBean proy) {
        this.proy = proy;
    }

    public FormularioBean getForm() {
        return form;
    }

    public void setForm(FormularioBean form) {
        this.form = form;
    }
  ...
  public void generateAll()
  {
    ...
    for (ParametroBean p : this.lista) {
      ...
      /*if(p.getNameCampo().substring(0, 2).equals("fk")){
        CRUDParameObject c= new CRUDParameObject(p.getNameCampo(), p.getNameCampo().substring(3,p.getNameCampo().length()));
        crud.add(c);
      }*/
      if (p.getEsPkey().equals("S")) {
        esPkey = true;
    ...
    createFile(psql.generateDto(crud, this.nombEnti), this.nombEnti.trim() + "Dto.java");

    createFile(psql.generateDao(crud, this.nombEnti), this.nombEnti.trim() + "Dao.java");

    CreateForms form = new CreateForms();
    form.addDescForm(this.getProy(), this.getForm());
    
    createFile(form.createForm(crud, this.nombEnti), this.nombEnti.trim() + "Form.xhtml");
    try {
