...
public class ParametroBean
    ...
    public int secuencia() {
     ...
     public void configFkey(String nombre){
  
        this.esPkey="N";
        this.esPkeyBol=false;
        this.tipoDato="NUMBER(10)";
        this.esObligatorio="S";
        this.NameCampo="fk"+nombre;
    ...
    private SelectItem comboTipo[] = {
        new SelectItem("Number(10)", "NUMERICO"), new SelectItem("VarChar2(80)", "NOMBRE"), 
        new SelectItem("VarChar2(250)", "DESCRIPCION"), new SelectItem("Date","FECHA")
    };
